 ...
 * Run from functions directory: cd functions && npx ts-node ../scripts/import-c3-orders-from-functions.ts
 */
...
function dateToTimestamp(dateStr: string): admin.firestore.Timestamp {
